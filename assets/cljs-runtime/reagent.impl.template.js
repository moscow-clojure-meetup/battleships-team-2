...
var G__36175 = o;
(G__36175[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__36211__delegate = function (args){
...
while (G__36212__i < G__36212__a.length) {G__36212__a[G__36212__i] = arguments[G__36212__i + 0]; ++G__36212__i;}
  args = new cljs.core.IndexedSeq(G__36212__a,0,null);
} 
return G__36211__delegate.call(this,args);};
...
return G__36211__delegate(args);
});
...
var G__36179 = o;
(G__36179[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__36182 = props;
var G__36182__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36182,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36182);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36182__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36183){
...
var props = map__36184__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36184__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__36184,map__36184__$1,props,class$){
return (function (c){
...
});})(map__36184,map__36184__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36186){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36187__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__36187,map__36187__$1,on_write){
return (function (){
...
});})(node_value,map__36187,map__36187__$1,on_write))
);
} else {
...
var G__36190 = jsprops;
(G__36190["defaultValue"] = value);

(G__36190["onChange"] = ((function (G__36190,v,value,on_change){
return (function (p1__36189_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36189_SHARP_);
});})(G__36190,v,value,on_change))
);
...
var vec__36192 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36192,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36192,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36192,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___36231 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___36231 == null)){
} else {
var key_36232 = temp__5724__auto___36231;
(jsprops["key"] = key_36232);
}
...
var temp__5724__auto___36233 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___36233 == null)){
} else {
var key_36234 = temp__5724__auto___36233;
reagent.impl.template.oset(jsprops,"key",key_36234);
}
...
var G__36196 = reagent.impl.template.__GT_NativeWrapper();
(G__36196["name"] = c);
...
var G__36197 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36197) : reagent.impl.template.as_element.call(null,G__36197));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36200){
var G__36201 = cljs.core.first(seq36200);
var seq36200__$1 = cljs.core.next(seq36200);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36201,seq36200__$1);
});
...
break;
default:
var G__36241 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36241;
continue;
...
var n__4607__auto___36246 = a.length;
var i_36248 = (0);
while(true){
if((i_36248 < n__4607__auto___36246)){
(a[i_36248] = reagent.impl.template.as_element((a[i_36248])));

var G__36249 = (i_36248 + (1));
i_36248 = G__36249;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___36250 = a.length;
var i_36251 = (0);
while(true){
if((i_36251 < n__4607__auto___36250)){
var val_36252 = (a[i_36251]);
if(((cljs.core.vector_QMARK_(val_36252)) && ((reagent.impl.template.key_from_vec(val_36252) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36251] = reagent.impl.template.as_element(val_36252));
...
var ctx = ({});
var vec__36204 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36204,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36204,(1),null);
...
var G__36207 = (cljs.core.count(argv) - first_child);
switch (G__36207) {
case (0):
...
case (1):
var G__36208 = comp;
var G__36209 = jsprops;
var G__36210 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__36208,G__36209,G__36210);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__36207){

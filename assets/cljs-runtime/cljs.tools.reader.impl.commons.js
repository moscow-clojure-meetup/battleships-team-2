...
var vec__27832 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27832,(0),null);
return (match === s);
});
...
var G__27847 = (i__4731__auto___27846 + (1));
i__4731__auto___27846 = G__27847;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq27837){
...
return (function() { 
var G__27848__delegate = function (rdr,_){
...
var G__27848 = function (rdr,var_args){
var _ = null;
...
while (G__27849__i < G__27849__a.length) {G__27849__a[G__27849__i] = arguments[G__27849__i + 1]; ++G__27849__i;}
  _ = new cljs.core.IndexedSeq(G__27849__a,0,null);
} 
return G__27848__delegate.call(this,rdr,_);};
G__27848.cljs$lang$maxFixedArity = 1;
G__27848.cljs$lang$applyTo = (function (arglist__27850){
var rdr = cljs.core.first(arglist__27850);
var _ = cljs.core.rest(arglist__27850);
return G__27848__delegate(rdr,_);
});
